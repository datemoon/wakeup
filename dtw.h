...
public:
    ...
    DtwAlign(int rows,int cols): dtw_(NULL),dtw_total_(NULL),align_(NULL),state_(NULL),dtw_rows_(rows),dtw_cols_(cols),start_location_(0),end_location_(0),total_load_rows_(0),cur_cols_(0){ }
    ...
    ~DtwAlign(){
        ...
        if(state_ != NULL){delete[]state_;state_=NULL;}
